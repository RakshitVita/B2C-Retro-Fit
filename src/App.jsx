...
import Dashboard from "./componets/SubscriptionPage/Dashboard";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/SubscriptionDashboard" element={<Dashboard/>}/>
        <Route path="/Demo" element={<SubscriptionDashboard/>}/>
      </Routes>
